...
// Add these two lines to adjust the zoom/scale behavior:
        webSettings.setUseWideViewPort(true);         // Allows the WebView to have a viewport meta tag effect.
        webSettings.setLoadWithOverviewMode(true);      // Loads the WebView completely zoomed out.

// Optionally, you can also set an initial scale, if needed:
 this.htmlViewer.setInitialScale(50);  // Adjust the scale percentage as desired.
...
// the web view would remain inconsistent on subsequent concurrent opens
        ...
        htmlViewer.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT));
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (action != null && action.equals(SHOW_WEBVIEW)) {
            ...
            this.htmlViewer.loadUrl("about:blank");
            this.htmlViewer.loadUrl("http://127.0.0.1:3000");
            //this.htmlViewer.loadUrl("https://ips-d2s-uksc-medsnomed-medsno.apps.ocp1.azure.dso.digital.mod.uk/");
        }
    }
